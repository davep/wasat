...
|---|---|
| [`__init__.py`](src/wasat/__init__.py) | Library entry point. Exposes public classes (`Client`, `Response`, `StatusCode`, `GeminiURI`, `TrustStore`, `FileTrustStore`) and exceptions, while keeping internal details hidden. |
